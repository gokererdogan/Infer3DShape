...
print gt.prior() * gt.likelihood(data)
...
print h1.prior() * h1.likelihood(data)
...
print h2.prior() * h2.likelihood(data)
...
data2 = np.load('test2.npy')

print gt2.prior() * gt2.likelihood(data2)
...
print h2_1.prior() * h2_1.likelihood(data2)
...
print h2_2.prior() * h2_2.likelihood(data2)
